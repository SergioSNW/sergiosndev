...
module.exports = {
  entry: {
    indexL:   './src/js/indexL.js',
    indexR:   './src/js/indexR.js'   
  },
  output: {
  ...
  plugins: [
    new StatsReportPlugin({ 
      //options
      title: "Composicion y volumenes de <components> (plugin: webpack-stats-report)",
      output: "./public/stats-lastBuild.html"
    }),
  ]
}
